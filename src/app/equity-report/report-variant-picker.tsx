...
export function ReportVariantPicker({ variant }: { variant: ReportVariant }) {
  ...
  return (
    <select
      ...
      className="print:hidden h-[30px] px-2.5 rounded-lg border border-white/15 bg-white/[0.06] text-xs font-medium text-white hover:bg-white/[0.12] transition-colors focus:outline-none focus:ring-1 focus:ring-white/30"
    >
