...
import { getContractsHealth, getLongestInPipeline, getMostRejectedTasks, getShippedSummary, getClientDependencies, getUnreadMentions, getTeamProjects, getMyTasks, getDevQueue, getPmQueue, getStageFunnel } from "@/actions/dashboard";
...
export default async function DashboardPage() {
  ...
  const [contractsHealth, pipelineTasks, rejectedTasks, shippedData, clientDeps, unreadMentions, teamProjects, myTasks, devQueue, pmQueue, funnelData] = await Promise.all([
    getContractsHealth(),
