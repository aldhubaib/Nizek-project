        ...
        {comments.map((c) => (
          <div key={c.id} className="group flex gap-s">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-s text-foreground/80 leading-relaxed mt-0.5 whitespace-pre-wrap break-words">
          ...
          >
            {filteredMembers.map((m, i) => (
              <button
                ...
                className={cn(
                  "flex items-center gap-2 w-full px-3 py-2 text-start text-s transition-colors",
