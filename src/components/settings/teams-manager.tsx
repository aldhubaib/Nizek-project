...
import {
  Pencil, Trash2, Loader2, X, Check, FolderKanban,
  ChevronDown, ChevronRight, Users, Shield, Crown, Clock, Mail,
} from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-s font-semibold">Teams</h2>
      ...
      {teams.length === 0 && !creating ? (
        <div className="text-center py-8">
          ...
          <p className="text-s text-muted-foreground">No teams yet. Create your first team.</p>
        </div>
      ) : (
              ...
              <div key={team.id} className="rounded-lg border border-border bg-card overflow-hidden">
                ...
                <div className="flex items-center justify-between gap-3 px-3 py-2.5 hover:bg-accent/30 transition-colors">
                  ...
                  >
                    ...
                    <span className="text-s font-medium truncate">{team.name}</span>
                    {team.isDefault && (
                      <span className="text-xs font-semibold px-1.5 py-0.5 rounded-full bg-primary/15 text-primary border border-primary/20">
                        DEFAULT
                      </span>
                    )}
                    <span className="text-xs text-muted-foreground font-mono flex items-center gap-2 shrink-0">
                          ...
                          {loadingUsers ? (
                            ...
                            <>
                              <select
                                ...
                                className="flex-1 rounded-md border border-border bg-background px-2 py-1 text-s text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
                              >
                              ...
                              <select
                                ...
                                className="rounded-md border border-border bg-background px-2 py-1 text-s text-foreground focus:outline-none focus:ring-1 focus:ring-ring w-24"
                              >
